...
namespace Microsoft.Samples.Kinect.DiscreteGestureBasics
{
    ...
    public sealed class GestureResultView : INotifyPropertyChanged
    {
        ...
        {
            this.UpdateGestureResult(isBodyTrackingIdValid, isGestureDetected, detectionConfidence, "");
        }
        ...
        internal void UpdateGestureResult(bool isBodyTrackingIdValid, bool isGestureDetected, float detectionConfidence, string gestureName)
        {
